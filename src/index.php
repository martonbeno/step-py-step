...
?>
	...
	<script>
		var analysis = '<?php echo addslashes($analysis_json); ?>';
		analysis = JSON.parse(analysis);
		var evaluation = '<?php echo addslashes($evaluation_json); ?>';
	...
	<script>
	var nodeStructure = '<?php echo addslashes($node_structure); ?>';
